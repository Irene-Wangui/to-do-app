...
class AppTextStyles {
  ...
  late final TextStyle displayLarge = _headlineFont.copyWith(
      fontSize: 32, fontWeight: FontWeight.w600); // M3 DisplayLarge (H1)
  late final TextStyle displayMedium = _headlineFont.copyWith(
      fontSize: 28, fontWeight: FontWeight.w600); // M3 DisplayMedium (H2)
  late final TextStyle displaySmall = _headlineFont.copyWith(
      fontSize: 24, fontWeight: FontWeight.w500); // M3 DisplaySmall (H3)

  late final TextStyle headlineLarge = _titleFont.copyWith(
      fontSize: 22, fontWeight: FontWeight.w700); // M3 HeadlineLarge (H4)
  late final TextStyle headlineMedium = _titleFont.copyWith(
      fontSize: 18, fontWeight: FontWeight.w600); // M3 HeadlineMedium (H5)
  late final TextStyle headlineSmall = _titleFont.copyWith(
      fontSize: 16, fontWeight: FontWeight.w600); // M3 HeadlineSmall (H6)

  late final TextStyle titleLarge =
      headlineLarge; // Reuse headline styles for title
  ...
  late final TextStyle bodyLarge =
      _contentFont.copyWith(fontSize: 16); // M3 BodyLarge
  late final TextStyle bodyMedium =
      _contentFont.copyWith(fontSize: 14); // M3 BodyMedium
  late final TextStyle bodySmall =
      _contentFont.copyWith(fontSize: 12); // M3 BodySmall

  late final TextStyle labelLarge =
      _labelFont.copyWith(fontSize: 14); // M3 LabelLarge
  late final TextStyle labelMedium =
      _labelFont.copyWith(fontSize: 12); // M3 LabelMedium
  late final TextStyle labelSmall =
      _labelFont.copyWith(fontSize: 11); // M3 LabelSmall
}
